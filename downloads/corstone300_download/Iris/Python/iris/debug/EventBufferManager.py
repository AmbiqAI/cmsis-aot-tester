...
class EventBufferManager(object):
    ...
    EventBufferCallbackDesc = {
            ...
            "args": {
                "sInstId": {"type": "NumberU64", "description": "Emitter's instance id"},
