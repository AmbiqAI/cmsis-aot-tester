...
class OpFullyConnected(OperationBase):
    ...
    def build_keras_model(self) -> tf.keras.Model:
        ...
        model.add(
            keras.layers.InputLayer(input_shape=(input_shape[3], ), batch_size=input_shape[0]))

        fully_connected_layer = keras.layers.Dense(filter_shape[0], activation=None, use_bias=True)
