...
class OpStridedSlice(OperationBase):
    ...
    def build_keras_model(self) -> tf.keras.Model:
        ...
        # StridedSlice operation - slice from index 1 to -1 with stride 2
        # This creates a common strided slice pattern
        x = tf.keras.layers.Lambda(
            lambda x: tf.strided_slice(x, [0, 1, 1, 0], [0, -1, -1, 0], [1, 2, 2, 1])
        )(inputs)
